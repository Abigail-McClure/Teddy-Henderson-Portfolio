...
// Revalidate project data every minute so Sanity updates show up
...
export default async function Home() {
  ...
  return (
    ...
    <Link
    href="/about"
    className="fixed right-6 top-6 rounded-lg border border-[hsla(20,80%,55%,0.85)] bg-white/80 px-3 py-1 text-sm font-medium
    ...
    about
      ...
      <div className="text-center">
        ...
        <h1 className="mt-4 text-5xl sm:text-6xl lg:text-7xl font-black leading-tight text-orange-400">
            Teddy Henderson 
        </h1>
        <p className="mt-4 text-lg sm:text-xl text-gray-600">Seattle-based 3D artist exploring color, texture, and light</p>
        <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gradient-to-r from-[hsla(22,92%,50%,0.95)] via-[hsla(22,84%,66%,1.00)] to-[hsla(29,77%,61%,0.80)]" />
      </div>
          ...
          >
            {project.image?.url && (
              <>
                ...
                { /**  the hover overlay that displays the alt text/title if no alt text present */ }
